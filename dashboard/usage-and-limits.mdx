...
| Section             | What it tells you                                                            | What you should see                                                  |
| ------------------- | ---------------------------------------------------------------------------- | -------------------------------------------------------------------- |
...
| **Plan limits**     | Published RPC, WebSocket, and supported streaming caps for the resolved tier | The selected access shows its current plan limits                    |
