...
These methods are answered by [FastGate](/products/fastgate-account-api) through the same URL and are documented in the [FastGate reference](/api-reference/fastgate/overview). The V2 methods add cursor pagination.
