...
| Location | Endpoint |
| --- | --- |
| Amsterdam | `rpc-ams.thornode.io:4802` |
| Salt Lake City | `rpc-slc1.thornode.io:4802` |
| Tokyo | `ap-northeast-1.thornode.io:4802` |
| Frankfurt | `rpc-fra1.thornode.io:4802` |
| New York | `rpc-nyc1.thornode.io:4802` |
| Singapore | `rpc-sgp1.thornode.io:4802` |
...
- Recent blockhash and caller-owned durable nonce transactions are supported, with the same [nonce requirements](/api-reference/hofund/sendtransaction#durable-nonce) as HTTP.
...
hofund-quic-client \
  --lane-endpoint rpc-fra1.thornode.io:4802 \
  --server-name rpc-fra1.thornode.io \
