...
Every Hofund location serves the same routes. `<location-base>` is `http://<host>:4343`, and the WebSocket form is `ws://<host>:4343`. The dashboard shows the exact URLs with your key filled in.
