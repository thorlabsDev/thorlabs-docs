...
| `429` | `-32003` | `fast submission rate limit exceeded` | Retry after `Retry-After`. All fast surfaces share one per-key limiter set by your pass tier (Flash 10, Classic 20, Elite 40, Prime 60 tx/s; burst twice the rate). |
