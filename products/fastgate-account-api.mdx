...
FastGate recognizes these method names.
...
Standard methods follow the request and response shapes in the [Solana JSON-RPC reference](https://solana.com/docs/rpc). ThorNode-specific V2 fields are documented below.
