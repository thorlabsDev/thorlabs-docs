...
ThorEdge handles standard Solana RPC calls and WebSocket subscriptions. Supported account-query methods use the same URL and are routed through [FastGate](/products/fastgate-account-api).
