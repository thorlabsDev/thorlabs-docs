...
| A provider-specific transaction operation            | [Bifrost Transaction Routes](/products/bifrost-transaction-routes) | The response defined by that route's contract           |
