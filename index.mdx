...
| Account-heavy queries through supported methods          | [FastGate RPC](/products/fastgate-rpc)             | Solana account data through the same ThorEdge HTTPS URL |
...
| A provider-specific transaction operation                | [Bifrost Transaction Routes](/products/bifrost-transaction-routes) | A route-specific HTTP response via your Bifrost key  |
