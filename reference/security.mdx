...
- Official Pulse clients currently do not verify the server certificate. Use a trusted private network or UDP-capable VPN, or use a custom client that pins or verifies the endpoint certificate.
