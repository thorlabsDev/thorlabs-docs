...
Refresh the supported-method list or **Bifrost** catalog for the selected access and location, then copy the complete URL again. Retry only after the method or route appears.
