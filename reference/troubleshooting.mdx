...
| Symptom                                | Verify                                                                                    | Expected result                                          | Action                                                                        | Retry?                             |
| -------------------------------------- | ----------------------------------------------------------------------------------------- | -------------------------------------------------------- | ----------------------------------------------------------------------------- | ---------------------------------- |
| RPC method or Bifrost route is missing | Complete product URL, supported method list, supplied route contract, and server response | The exact method or provider operation remains supported | Refresh the current product or route contract and replace stale configuration | **No**, until the contract matches |
